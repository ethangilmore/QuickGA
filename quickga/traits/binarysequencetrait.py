...
class BinarySequenceTrait(SequenceTrait):
    """A Trait whose value is a List (or "Sequence") of 0's and 1's

    initialize:
        Value initializes to a list of 0's and 1's
    ...
    def __init__(self, length: int, crossover_type: str='2-point', mutation_type: str='random-reset',
            mutation_rate: float=0.05, n: int=None):
        """
        Args:
            length: int
